...
export class AuthStack extends Stack {
  ...
  private onAuthenticatedRole: Role;
  ...
  private createRoles(photosBucket: IBucket) {
    ...
    this.onAuthenticatedRole = new Role(this, 'CognitoDefaultUnauthenticatedRole', {
      assumedBy: new FederatedPrincipal('cognito-identity.amazonaws.com', {
        StringEquals: {
          'cognito-identity.amazonaws.com:aud': this.identityPool.ref,
        },
  ...
  private attachRole() {
    new CfnIdentityPoolRoleAttachment(this, 'RoleAttachment', {
      ...
      roles: {
        ...
        unauthenticated: this.onAuthenticatedRole.roleArn,
      },
      roleMappings: {
        adminsMapping: {
          type: 'Token',
